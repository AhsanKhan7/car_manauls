    ...
    <section className="work-with-us mt-20 mb-20">
      <Container>
        <Row className="section_title">
          <Col>
            <h2>
              <span><strong>Advertise with CarManuals.org</strong></span>
            </h2>
          </Col>
        </Row>
        <Row className="mb-50">
          <Col lg={12}>
            <div className="mb-15">
              <p className="large-text">If you are interested in advertising opportunities please contact us below.</p>
            </div>
          </Col>
          <Col lg={6}>
          ...
          <Col lg={6}>
            <Tabs defaultActiveKey="advertise" className="info-tabs">
